...
var loadEventsByCity = function(url, brewUrl) {
      fetch(url)  
          ...
          .then(function(response) {
            ...
            if ( responseNum === 0) {
             var errorText = 'Error: City not found';
      ...
      .catch(function(error) {
        var catchAlerText = 'unable to connect to one or more apis';

        modalOpen(catchAlerText);
      });
...
// modal open aand close functions
...
// function to search and append info from the openBreweryDb api
...
// function to search and append info from documenu api
